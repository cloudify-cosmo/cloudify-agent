...
def test_start(initd_daemon):
    shared._test_start(initd_daemon)
...
def test_start_delete_amqp_queue(initd_daemon):
    shared._test_start_delete_amqp_queue(initd_daemon)
...
def test_start_with_error(initd_daemon):
    shared._test_start_with_error(initd_daemon)
...
def test_start_short_timeout(initd_daemon):
    shared._test_start_short_timeout(initd_daemon)
...
def test_status(initd_daemon):
    shared._test_status(initd_daemon)
...
def test_stop(initd_daemon):
    shared._test_stop(initd_daemon)
...
def test_stop_short_timeout(initd_daemon):
    shared._test_stop_short_timeout(initd_daemon)
...
def test_restart(initd_daemon):
    shared._test_restart(initd_daemon)
...
def test_two_daemons(initd_daemon):
    shared._test_two_daemons(initd_daemon)
...
def test_conf_env_variables(initd_daemon):
    shared._test_conf_env_variables(initd_daemon)
...
def test_extra_env(initd_daemon):
    shared._test_extra_env(initd_daemon)
...
def test_execution_env(initd_daemon):
    shared._test_execution_env(initd_daemon)
...
def test_logging(initd_daemon):
    shared._test_logging(initd_daemon)
